...
<div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 px-4 py-6">
  <p className="text-lg text-gray-800">User ID: {userId}</p>
  
  <div className="mt-6">
    <h3 className="text-xl font-semibold text-gray-800 mb-4">Select an API Key:</h3>
    <select 
  ...
  <div className="mt-6">
    <p className="text-md text-gray-800 mb-2">Selected API Key: <span className="font-semibold">{selectedAPIKey}</span></p>
    <button 
      onClick={useApiKey} 
